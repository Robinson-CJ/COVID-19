    ...
    <div class="policy-main">
      ...
      <div class="policy-desc">
        ...
        <div class="qr">
          ...
          <van-cell-group>
            <van-cell
              :title="fromInfo.city_name"
              :value="fromInfo.health_code_name"
              is-link
              icon="qr"
              @click="showFromPopup"
            />
            <van-cell
              :title="toInfo.city_name"
              :value="toInfo.health_code_name"
              is-link
              icon="qr"
              @click="showToPopup"
            />
          ...
          <van-dialog
            ...
            theme="round-button"
            :title="fromInfo.health_code_desc"
          >
            <div class="qr-image">
